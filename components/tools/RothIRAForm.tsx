...
/* ─── Main component ─────────────────────────────────────── */
export default function RothIRAForm({ initialValues }: RothIRACalculatorProps) {
            ...
            <div className="w-[100%]">
              <div className="card p-[28px] max-md:p-[20px_18px] flex flex-col gap-[20px] max-md:gap-[16px]">
                ...
                {earlyWithdrawalWarning && (
                  <div className="calc-fade-in flex gap-[10px] p-[12px] bg-[var(--accent-bg)] border-[1px] border-[var(--accent-border)] rounded-[12px] overflow-hidden">
                ...
                {incomeWarning === "ineligible" && (
                  <div className="calc-fade-in p-[12px] bg-[#fff1f2] border-[1px] border-[#fecdd3] rounded-[12px] flex gap-[10px] overflow-hidden">
                ...
                {incomeWarning === "phase_out" && (
                  <div className="calc-fade-in p-[12px] bg-[#fefce8] border-[1px] border-[#fde68a] rounded-[12px] flex gap-[10px] overflow-hidden">
